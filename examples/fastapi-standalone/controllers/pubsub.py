from models.pubsub import PubSubModel
from utils.common import Singleton

class PubSubController(metaclass=Singleton):
    __name__ = 'pubsub'

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.model = PubSubModel()
    ...
    async def async_event_rl_native_pubsub(self, *args, **kwargs):
        result = await self.model.async_event_rl_native_pubsub(self, *args, **kwargs)
        return result
