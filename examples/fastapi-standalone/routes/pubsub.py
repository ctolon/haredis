...
from controllers.pubsub import PubSubController
...
def sync_event_without_rl(req: Request, example_request: ExampleRequest):
    ...
    pubsub_controller = PubSubController()
    
    # Call Acquire the lock function from model
    result = pubsub_controller.sync_event_without_rl(
        req=req,
        param1=param1,
        param2=param2
    )
...
async def async_event_without_rl(req: Request, example_request: ExampleRequest):
    ...
    # Call Acquire the lock function from model
    result = await pubsub_controller.async_event_without_rl(
        req=req,
        param1=param1,
        param2=param2
    )
...
async def async_event_decorated(req: Request, example_request: ExampleRequest):
    ...
    # Call Acquire the lock function from model
    result = await pubsub_controller.async_event_decorated(
        req=req,
        param1=param1,
        param2=param2
    )
...
async def sync_event_decorated(req: Request, example_request: ExampleRequest):
    ...
    # Call Acquire the lock function from model
    result = await pubsub_controller.sync_event_decorated(
        req=req,
        param1=param1,
        param2=param2
    )
...
async def async_event_decorated_wrapped(req: Request, example_request: ExampleRequest):
    ...
    # Call Acquire the lock function from model
    result = await pubsub_controller.async_event_decorated_wrapped(
        req=req,
        param1=param1,
        param2=param2
    )
...
async def sync_event_decorated_wrapped(req: Request, example_request: ExampleRequest):
    ...
    # Call Acquire the lock function from model
    result = await pubsub_controller.sync_event_decorated_wrapped(
        req=req,
        param1=param1,
        param2=param2
    )
...
async def async_event_rl_native(req: Request, example_request: ExampleRequest):
    ...
    # Call Acquire the lock function from model
    result = await pubsub_controller.async_event_rl_native(
        req=req,
        param1=param1,
        param2=param2
    )
...
async def sync_event_rl_native(req: Request, example_request: ExampleRequest):
    ...
    # Call Acquire the lock function from model
    result = await pubsub_controller.sync_event_rl_native(
        req=req,
        param1=param1,
        param2=param2
    )
